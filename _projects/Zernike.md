...
img: assets/img/Zernike.png
importance: 2
category: Finished
---

{% include figure.html path="assets/img/Zernike.png" title="Zernike-Based Keratoconus Classification" class="img-fluid rounded z-depth-1" %}
