...
layout: page
title: BetterReads
description: BetterReads is a social network that connects reading enthusiasts worldwide, revolutionizing how they engage with literature.
img: assets/img/Better_Reads.jpeg
importance: 2
category: Capstone Projects
---

{% include figure.html path="assets/img/Better_Reads.jpeg" title="BetterReads" class="img-fluid rounded z-depth-1" %}
